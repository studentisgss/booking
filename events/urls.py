...
from events.views import Agenda, Calendar, Monitor, EventsApprovationView, EventsApprovationConfirmView
...
urlpatterns = [
    ...
    url(r'^approvation/(?P<id>\d+)/(?P<action>\d{1})$', EventsApprovationConfirmView.as_view(), name="approvationConfirm"),
]
