...
from news.views import NewsView, NewsEditView, NewsAddView, NewsDeleteView, NewsList, NewsDetails
...
urlpatterns = [
    ...
    url(r'^newslist$', NewsList.as_view(), name="news_list"),
    url(r'^newsdetails/(?P<id>\d+)$', NewsDetails.as_view(), name="news_detail"),
]
